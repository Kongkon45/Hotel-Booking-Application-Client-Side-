          ...
          return (
            ...
            >
              ...
              <div className="flex justify-center items-center gap-1">
                ...
                <p className="lg:text-md md:text-sm text-xs text-center">{room.location}</p>
              </div>
              <div className="flex justify-between items-center lg:gap-3 md:gap-2 gap-1 lg:mx-3 md:mx-2 mx-1 mt-2">
                ...
                <button
                  ...
                  className={`text-sm font-semibold hover:bg-[#fd3d57] hover:text-white border border-[#fd3d57] rounded-lg text-[#fd3d57] lg:py-1 md:py-1 py-0.5 lg:px-2 md:px-1 px-0.5 transition-all ease-in-out delay-500 duration-700 ${
                    isButtonClicked ? "opacity-50 cursor-not-allowed" : ""
                  }`}
                >
                  {isButtonClicked ? "Booking..." : "Book Now"}
                </button>
              </div>
            </div>
          );
